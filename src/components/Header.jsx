...
import { setReadNotifications } from "../store/features/appData/appDataSlice";
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="flex items-center ml-auto">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center px-1 py-1 text-xs text-white bg-orange-300 rounded-full shadow-md bg-transparent border border-white"
                ...
                openNotificationModal ?
                   <Modal
                        ...
                        <div className="font-semibold text-white bg-primary " style={{width:"400px",maxWidth:"90vw"}}>
                            ...
                            <div className="p-3 pb-1 text-md">
                            {appData?.last_notification?.description}
                            </div>
                            <div className="p-3 pt-1 text-gray-300">
