	...
	useEffect(() => {
		...
		const fetchData = async () => {
			...
			try {
				...
				const fetchDesawarMarketsPromise = localStorage.getItem('authToken') ? getMarkets('desawar') : Promise.resolve();
				const fetchGeneralMarketsPromise = localStorage.getItem('authToken') ? getMarkets('general') : Promise.resolve();
